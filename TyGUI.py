#the script for generating the TyGUI project
...
PROJECT_INCLUDE_DIR = "TyGUI/includes"
...
def GeneratePremake():
    ...
    KARProject.location = "TyGUI"
    KARProject.desc = "The ImGUI implementation for handling ImGUI widgets in BTD projects"
